;-----------------------------------------------------------------
	pro plot_circle, xval, yval, size, fill=fill,$
...
;
; CALLING SEQUENCE:	plot_circle, xval, yval, size, /FILL, COLOR=c, THICK=t, /OVERPLOT
;
; INPUTS:	xval    = x position of the center of the circle	
;           yval    = y position of the center of the circle
;			size	= radius of circle in data units
;
;	KEYWORDS:
